    ...
    <div>
      <header class="w">
        <div class="w-box">
          ...
          <div class="right-box">
            <div class="nav-list">
              <el-input placeholder="请输入商品的信息" suffix-icon="el-icon-search" v-model="productInfo"></el-input>
            ...
            <div class="nav-aside">
              ...
              <div class="user pr">
                ...
                <div class="nav-user-wrapper pa active " v-if="login">
      ...
      <slot name="nav">
        <div class="nav-sub">
          ...
          <div class="nav-sub-wrapper">
            <div class="w">
              <el-breadcrumb separator-class="el-icon-arrow-right" height="480px">
